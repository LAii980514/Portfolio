...
export function FeaturedProjects() {
  return (
    <section id="portfolio" className="relative w-full py-32 flex flex-col items-center">
      <div className="w-full max-w-7xl px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {featuredProjects.map((project, index) => (
            ...
            >
              <div className="relative flex flex-col h-full overflow-hidden rounded-2xl bg-white/[0.03] border border-white/10 hover:border-[#A78BFA]/50 hover:shadow-[0_0_20px_rgba(167,139,250,0.15)] transition-all duration-300">
                {/* Project Image */}
                <div className="relative aspect-[16/9] overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-secondary/30 to-background flex items-center justify-center">
                    <span className="text-muted-foreground/50 text-lg">Project Image</span>
                  </div>
                  <motion.div
                ...
                <div className="p-8 md:p-12 flex-1 flex flex-col">
                  ...
                  <motion.button
                    whileHover={{ x: 4 }}
                    className="inline-flex items-center self-start gap-2 text-sm font-medium text-primary mt-auto"
                  >
                    자세히 보기
