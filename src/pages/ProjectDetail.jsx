              ...
              <div className="surface-2" style={{
                ...
                {project.coreExperience && (
                  <div style={{ paddingBottom: '12px' }}>
                    ...
                    <div className="text-body-sm" style={{ fontWeight: 500, color: 'var(--colors-ink-subtle)', lineHeight: 1.5, wordBreak: 'keep-all' }}>{project.coreExperience}</div>
                  </div>
                )}
                ...
                {project.references && (
                  <div style={{ paddingBottom: '12px' }}>
                    ...
                    <div className="text-body-sm" style={{ fontWeight: 500, color: 'var(--colors-ink-subtle)', lineHeight: 1.5, wordBreak: 'keep-all' }}>{project.references}</div>
                  </div>
                )}
